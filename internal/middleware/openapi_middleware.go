...
import (
	...
	"github.com/cossteam/hipush/pkg/code"
)
...
func HandleOpenAPIError(c *gin.Context, message string, statusCode int) {
	...
	c.JSON(http.StatusBadRequest, v1.Response{Code: statusCode, Message: message})
}
...
func HandleOpenApiAuthentication(ctx context.Context, input *openapi3filter.AuthenticationInput) error {
